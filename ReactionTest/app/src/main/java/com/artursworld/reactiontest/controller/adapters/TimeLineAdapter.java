...
public class TimeLineAdapter extends RecyclerView.Adapter<TimeLineViewHolder>  {
    ...
    private List<InOpEvent> itemList;
    private Context mContext;
    private TimeLineItemClickListener listener;
    private Activity activity = null;

    public TimeLineAdapter(List<InOpEvent> feedList, TimeLineItemClickListener listener, Activity activity) {
    ...
    public void onBindViewHolder(TimeLineViewHolder holder, int position) {
        ...
        InOpEvent timeLineModel =  itemList.get(position);

        holder.name.setText(timeLineModel.getType()+ ": " + timeLineModel.getHoursAndMinutes() + " " +activity.getResources().getString(R.string.oclock));
