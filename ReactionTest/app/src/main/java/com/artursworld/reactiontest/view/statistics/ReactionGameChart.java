    ...
    private void setData() {
        ...
        new AsyncTask<Void, Void, BarData>() {
            ...
            protected BarData doInBackground(Void... params) {
                ...
                reactionTimes.add(new BarEntry(0.1f, -1f));
                reactionTimes.add(new BarEntry(0.25f, preOpAvgReactionTime));
                ...
                set1 = new BarDataSetGoGame(reactionTimes, activity.getResources().getString(R.string.average_reaction_time));
                set1.setColors(new int[]{
                        //getColor(R.color.colorPrimary, activity.getTheme())
